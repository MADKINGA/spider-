...
def main():
    username='535220210@qq.com'
    userpassword='wybdhs630803'
    start_station='杭州东'
    end_station='德清'
    date='2019-06-13'
...
def loginandget(username,userpassword,start_station,end_station,date):
    ...
    for i in lt:
        try:
            ...
            print("number:"+number+",start:"+start+",end:"+end+",starttime:"+starttime+",endtime:"+endtime+",time:"+times)
        except:
            None
...
def get_a_verify_pic(b):
    if(os.path.exists("C:/Users/MADKING/Downloads/captcha-image.jpeg")):
        os.remove("C:/Users/MADKING/Downloads/captcha-image.jpeg")
...
def ana_pic(pic_name):
    ...
    files={'pic_xxfile':(pic_name,open("C:/Users/MADKING/Downloads/"+pic_name,'rb'),'image/png')}
